# React Native Vietnamese Lunar Calendars - A fork of React Native Calendar🗓️ 📆
...
<kbd>
  <img src="https://github.com/vinhnglx/react-native-vietnamese-lunar-calendar/blob/master/demo/vietnamese-lunar-date.png?raw=true">
</kbd>
...
```javascript
<Calendar
  // Allow lunar date. Default = false
  allowLunarDate
  // Initially visible month. Default = Date()
  current={'2012-03-01'}
  // Minimum date that can be selected, dates before minDate will be grayed out. Default = undefined
